...
const KriteriaRisikoFrekuensiMatrix = () => {
        ...
        try {
            ...
            if (kategoriRes.data && kategoriRes.data.length > 0) {
                ...
                setKategoriFrekuensi([
                    { key: 1, nama: 'Hampir tidak terjadi' },
                    { key: 2, nama: 'Jarang terjadi' },
                    { key: 3, nama: 'Kadang terjadi' },
                    { key: 4, nama: 'Sering terjadi' },
                    { key: 5, nama: 'Hampir pasti terjadi' }
                ]);
            }
    ...
    const saveKategori = async () => {
        try {
            setKategoriFrekuensi(kategoriFrekuensi.map(k =>
            ...
            <div className="main-content">
                <div className="card p-4">
                    <div className="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            <h4 className="mb-1">Pengisian Kategori dan Kriteria Frekuensi Risiko</h4>
                            <p className="text-muted mb-0">
                                Pilih skala frekuensi dan atur kategori, penjelasan, serta kriteria untuk setiap level
                            </p>
                        </div>
