...
const KriteriaRisikoDampakMatrix = () => {
  ...
  const savePenjelasan = async () => {
    try {
      setKategoriDampak(
        kategoriDampak.map((k) =>
          k.key === penjelasanForm.id
            ? { ...k, penjelasan: penjelasanForm.penjelasan }
            : k,
        ),
      );
          ...
          {loading ? (
            ...
            <>
              ...
              <div className="mt-4">
                ...
                <ol className="small">
                  <li>
                    <strong>A. Mengisi Level/Kategori:</strong> Klik ikon edit
                    pada header kolom untuk mengisi nama kategori
                  </li>
                  <li>
                    <strong>B. Mengisi Penjelasan:</strong> Klik pada sel untuk
                    mengisi penjelasan kategori
                  </li>
                  <li>
                    <strong>C. Mengisi Kriteria:</strong> Klik pada sel hijau
                    untuk mengisi detail kriteria
                  </li>
                  <li>
                    Gunakan tombol <FiPlus /> untuk menambah jenis kriteria baru
                  </li>
                  <li>
                    Gunakan tombol <FiMinus /> untuk menghapus jenis kriteria
                  </li>
                </ol>
              </div>
            </>
        ...
        <Modal.Body>
          <Form>
            <Form.Group className="mb-3">
              ...
              <Form.Control
                type="text"
                value={kriteriaForm.kategori_nama}
                disabled
              />
            </Form.Group>
            <Form.Group className="mb-3">
              ...
              <Form.Control
                type="text"
                value={kriteriaForm.jenis_kriteria}
                disabled
              />
            </Form.Group>
            <Form.Group className="mb-3">
          ...
          <div className="alert alert-info">
            <small>
              <strong>Contoh:</strong> Kategori x Penjelasan = Kriteria
              <br />
              Misal: Signifikan (4) x Beban Keuangan Negara = ≤1% dari total
              anggaran
            </small>
          </div>
        </Modal.Body>
