...
const JenisPenyebabTabel = () => {
      ...
      try {
        ...
        if (idIndukUnitKerja) {
          ...
          response = await axios.get(
            API_ENDPOINTS.getJenisPenyebabByInstansiAndIndukUnitKerja(
              idInstansi,
              idIndukUnitKerja,
            ),
            {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      await axios.delete(
        API_ENDPOINTS.deleteJenisPenyebab(selectedJenisPenyebab.id),
        {
      ...
      setJenisPenyebab((prev) =>
        prev.filter((item) => item.id !== selectedJenisPenyebab.id),
      );
      setShowModal(false);
  ...
  const columns = useMemo(
    () => getJenisPenyebabColumns(handleActionClick, user),
