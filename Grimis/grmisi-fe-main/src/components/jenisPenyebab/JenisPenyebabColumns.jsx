...
import getJenisPenyebabActions from './JenisPenyebabActions';

export const getJenisPenyebabColumns = (handleActionClick, user) => [
    {
        ...
        cell: (info) => {
            ...
            const actionItems = getJenisPenyebabActions(user?.role);
