...
const SelectDropdownSkorKemungkinan = ({ options, selectedOption, onSelectOption, className, defaultSelect }) => {
        ...
        <div className={`select-dropdown select-dropdown-sm ${className ? className : ""} ${openUpwards ? 'open-upwards' : ''} rounded-4`} ref={dropdownRef}>
            <div className={"select-box select-box-sm rounded-4"} onClick={toggleDropdown}>
                {localSelectedOption ? (
                    ...
                    <span className="text-muted">Pilih Skor Probabilitas...</span>
                )}
...
SelectDropdownSkorKemungkinan.propTypes = {
...
export default SelectDropdownSkorKemungkinan;