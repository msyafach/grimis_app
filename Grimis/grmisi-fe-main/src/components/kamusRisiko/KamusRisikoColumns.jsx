...
import getKamusRisikoActions from './KamusRisikoActions';

export const getKamusRisikoColumns = (handleActionClick, user) => [
    {
        ...
        cell: (info) => {
            ...
            const actionItems = getKamusRisikoActions(user?.role);
