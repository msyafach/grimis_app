...
const ResidualRiskContent = ({ title = "Skor / Nilai Residual Risk" }) => {
    ...
    useEffect(() => {
        const fetchAllData = async () => {
            ...
            try {
                ...
                const [indentifikasiRes, kemungkinanRes, dampakRes, residualRes, skorFreqRes, skorDampakRes, matriksRes] = await Promise.all([
                ...
                setSelectedKemungkinan({
                    label: kemungkinanRes.data.find(k => k.id === residualRes.data.kemungkinan_id)?.deskripsi || '',
                    value: residualRes.data.kemungkinan_id
                });
                setSelectedDampak({
                    label: dampakRes.data.find(d => d.id === residualRes.data.dampak_id)?.deskripsi || '',
                    value: residualRes.data.dampak_id
                });
...
ResidualRiskContent.propTypes = {
    title: PropTypes.string,
};

export default ResidualRiskContent;
