...
const AnalisisExistingControlEditTabel = forwardRef((props, ref) => {
...
AnalisisExistingControlEditTabel.displayName = "AnalisisExistingControlEditTabel";

export default AnalisisExistingControlEditTabel;
