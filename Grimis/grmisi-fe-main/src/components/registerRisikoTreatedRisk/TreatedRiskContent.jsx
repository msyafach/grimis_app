...
const TreatedRiskContent = ({ title = "Skor / Nilai Treated Risk" }) => {
        ...
        const fetchAllData = async () => {
            ...
            try {
                ...
                if (analisisRisikoResponse.data && analisisRisikoResponse.data.length > 0) {
                    ...
                    setLevel(analisisData.level_risiko_treated || 0);
                    setSelectedKriteriaSkorKemungkinan(analisisData.skor_kemungkinan_treated);
                    setSelectedKriteriaSkorDampak(analisisData.skor_dampak_treated);
                }
    ...
    const handleSave = async (e) => {
        ...
        const payload = {
            ...
            skor_kemungkinan_treated: Number(selectedKriteriaSkorKemungkinan),
            skor_dampak_treated: Number(selectedKriteriaSkorDampak),
        };
        ...
        try {
            ...
            if (selectedIdAnalisisRisiko) {
                ...
                setLevel(res.data.level_risiko_treated || 0);
            } else {
            ...
            Swal.fire({
                icon: 'success',
                title: 'Berhasil',
                text: 'Data Treated Risk berhasil disimpan',
            });
        } catch (error) {
