...
import { FiEye, FiMessageSquare, FiSend, FiTrash2, FiLock, FiUnlock } from 'react-icons/fi';
...
const IdentifikasiRisikoDetailContent = ({ title = "Detail Pernyataan Risiko" }) => {
    ...
    const handleNavigateTo = (subpath) => {
        if (!analisisRisiko?.id) return;
        navigate(`/pengelolaan-risiko/identifikasi-risiko/detail/${identifikasiId}/${subpath}`, {
                    ...
                    <div className="row">
                        ...
                        <div className="col-4 d-flex justify-content-end">
                            <button className="btn btn-md btn-primary" type="button"
                                onClick={() => navigate(`/pengelolaan-risiko/identifikasi-risiko/detail/${identifikasiId}/detail`)}
                            >
                                <FiEye size={16} className="me-2" /> Lihat Detail
                            </button>
                        </div>
                    </div>
...
IdentifikasiRisikoDetailContent.propTypes = {
    title: PropTypes.string,
};

export default IdentifikasiRisikoDetailContent;
