...
const KategoriRisikoTambahContent = ({ title = "Tambah Kategori Risiko", resetKey }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.post(API_ENDPOINTS.postKategoriRisiko, submissionData, {
                headers: { Authorization: `Bearer ${token}` },
            });
            
            showToast("success", "Kategori Risiko Berhasil Ditambahkan!");
...
KategoriRisikoTambahContent.propTypes = {
    title: PropTypes.string,
    resetKey: PropTypes.func.isRequired,
};

export default KategoriRisikoTambahContent;
