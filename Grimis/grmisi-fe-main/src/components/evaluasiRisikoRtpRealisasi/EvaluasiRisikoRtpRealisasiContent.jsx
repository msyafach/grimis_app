...
import FileTabelModal from './FileTabelModal';
import { validateIds } from '@/utils/validateIds';

setLanguage('id');

const EvaluasiRisikoRtpRealisasiContent = ({ title = "Realisasi RTP Evaluasi Risiko" }) => {
    ...
    const [showFileTabelModal, setShowFileTabelModal] = useState(false);
    ...
    const fetchData = useCallback(async () => {
        ...
        try {
            ...
            setFormDataRtp({
                ...
                tanggal_realisasi: rtpData.tanggal_realisasi,
                uraian_hambatan: rtpData.uraian_hambatan,
                attachments_count: Array.isArray(rtpData.attachments) ? rtpData.attachments.length : 0
            });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (isByAI) {
                ...
                if (formDataEvaluasi.jenis === 'dampak') {
    ...
    return (
        <>
                    ...
                    {evaluasiRisikoRtp.length === 0 ? (
                        ...
                        <form onSubmit={handleSubmit}>
                            <FormEvaluasiRisikoRtp
                                ...
                                setShowFileTabelModal={setShowFileTabelModal}
                            />
            ...
            />
            <FileTabelModal
                show={showFileTabelModal}
                onClose={() => setShowFileTabelModal(false)}
                rtpId={rtpId}
                setShowUploadModal={setShowUploadModal}
            />
        </>
...
EvaluasiRisikoRtpRealisasiContent.propTypes = {
    title: PropTypes.string
};

export default EvaluasiRisikoRtpRealisasiContent;
