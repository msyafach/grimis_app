            ...
            <div className="row">
                <div className="col-12 bg-light p-4 rounded-4">
                    ...
                    <div className="m-2">
                        ...
                        <strong>Pernyataan Risiko:</strong> {evaluasiRisikoRtp.identifikasi?.pernyataan_risiko || '-'}
                ...
                <div className="col-12 bg-light rounded-4 p-3 my-3">
                    <div className="d-flex justify-content-between align-items-center flex-wrap gap-2">
                        ...
                        <div className="d-flex gap-2">
                            <button
                                className={`btn ${!isByAIEvaluasi ? 'btn-primary' : 'btn-outline-secondary'}`}
                                type="button"
                                onClick={() => setIsByAIEvaluasi(false)}
                            >
                                <FiEdit size={16} className="me-2" />
                                Input Manual
                            </button>
                            <button
                                className={`btn ${isByAIEvaluasi ? 'btn-success' : 'btn-outline-success'}`}
                                type="button"
                                onClick={() => setIsByAIEvaluasi(true)}
                            >
                        ...
                        {!isJenisDampak && (
                            <div className="col-6">
                                <div className="mb-4">
                                    ...
                                    <SelectDropdown
                                        className="rounded-4"
                                        options={jenisPenyebab.map((item) => ({
                                            label: item.nama,
                                            value: item.id,
                                        }))}
                        ...
                        <div className="col-6">
                            <div className="mb-4">
                                ...
                                <SelectDropdown
                                    className="rounded-4"
                                    options={[
                                        { label: 'Pengendalian Fisik', value: 'Pengendalian Fisik' },
                                        { label: 'Pengendalian Dokumen', value: 'Pengendalian Dokumen' },
                                        { label: 'Pengendalian Aplikasi', value: 'Pengendalian Aplikasi' }
                                    ]}
                                    selectedOption={
                                        formDataRtp.output
                                            ? { label: formDataRtp.output, value: formDataRtp.output }
                                            : null
                                    }
                                    onSelectOption={(selected) =>
                                        handleInput({
                        ...
                        <div className="col-6">
                            <div className="mb-4">
                                <label className="form-label">
                                    Target Waktu <span className="text-danger">*</span>
                                </label>
                                <input
                                    type="datetime-local"
                                    className="form-control form-control-sm rounded-4"
                                    ...
                                    value={
                                        formDataRtp.target_waktu
                                            ? new Date(formDataRtp.target_waktu).toISOString().slice(0, 19)
                                            : ''
                                    }
                                    onChange={handleInput}
                                    required
