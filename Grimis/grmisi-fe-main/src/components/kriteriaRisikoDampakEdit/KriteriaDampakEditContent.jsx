...
const KriteriaDampakEditContent = ({ title = "Edit Kriteria Risiko Dampak" }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const token = localStorage.getItem("access_token");
            await axios.put(API_ENDPOINTS.putKriteriaRisikoDampak(kriteriaDampakId), formData, {
                headers: { Authorization: `Bearer ${token}` },
            });
            showToast("success", "Kriteria Risiko Dampak Berhasil Diperbarui!");
            fetchData();
        } catch (error) {
...
KriteriaDampakEditContent.propTypes = {
    title: PropTypes.string,
};

export default KriteriaDampakEditContent;
