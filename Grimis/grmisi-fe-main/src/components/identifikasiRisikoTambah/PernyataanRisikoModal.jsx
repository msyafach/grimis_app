...
const PernyataanRisikoModal = ({
    ...
    return (
        <Modal show={show} onHide={handleClose} centered size="xl" dialogClassName="modal-dialog-scrollable">
            <Modal.Header closeButton>
                <Modal.Title className="fs-6">Generate Pernyataan Risiko</Modal.Title>
            </Modal.Header>
