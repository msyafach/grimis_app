...
const KriteriaKemungkinanDetailContent = ({ title = "Detail Kriteria Risiko Kemungkinan" }) => {
...
KriteriaKemungkinanDetailContent.propTypes = {
    title: PropTypes.string,
    resetKey: PropTypes.func.isRequired,
};

export default KriteriaKemungkinanDetailContent;