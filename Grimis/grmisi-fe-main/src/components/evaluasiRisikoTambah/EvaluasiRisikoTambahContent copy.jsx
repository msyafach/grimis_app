    ...
    return (
        <div className="card">
                ...
                <ContentLoaderWrapper loading={loading} error={errorMessage}>
                    <form onSubmit={handleSubmit}>
                        <FormEvaluasiRisiko
                            ...
                            onAddEntry={(entry) => setSelectedEntries([...selectedEntries, entry])}
                        ...
                        <div className="d-flex justify-content-end gap-2 mt-3">
                            ...
                            <button type="submit" className="btn btn-primary" disabled={selectedEntries.length === 0}>
            ...
            <AkarPenyebabModal
                ...
                selectedRootCauseId={currentEditIndex >= 0 ? selectedEntries[currentEditIndex]?.root_cause_id : null}
            />
        </div>
    );
};
