...
const MENU_PERMISSION_MAP = {
    ...
    'parameters/pengisian-kategori-kriteria-dampak': ['manage:parameters'],
...
export const getFeatureName = (menuPath) => {
    const featureNames = {
        ...
        'parameters/pengisian-kategori-kriteria-dampak': 'Pengisian Kategori dan Kriteria Dampak Risiko',
